...
export function ReportsPage() {
  ...
  const tabs: { id: ReportTab; label: string }[] = [
    ...
    { id: 'bookings', label: 'Booking Profit' },
  ...
  return (
    <div className="space-y-6">
      ...
      {(tab === 'income' || tab === 'expenses' || tab === 'transactions') && (
        ...
        <>
          {tab === 'dashboard' && dashboard && (
            <div className="space-y-6">
              ...
              <div id="report-export-dashboard" className="space-y-6 bg-white p-6 text-[#1a1a1a]">
            ...
            <div id="report-export-income" className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <ReportExportBar
                  ...
                  headers={['Date', 'Client', 'Invoice', 'Booking', 'Method', 'Amount']}
                  rows={incomeRows}
                />
              </div>
              <ReportTable
          ...
          {tab === 'monthly' && (
            <div id="report-export-monthly" className="space-y-4">
              <ReportExportBar
                ...
                headers={['Month', 'Bookings', 'Invoice Value', 'Received', 'Expenses', 'Profit', 'Outstanding']}
                rows={monthlyRows}
              />
              <ReportTable
                headers={['Month', 'Bookings', 'Invoice Value', 'Received', 'Expenses', 'Profit', 'Outstanding']}
